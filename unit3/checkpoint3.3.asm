...
.segmentdef Zeropage [min=$bf00, max=$bfff, fill]
  ...
  .label current_screen_line_40 = 4
...
detect_devices: {
  ...
  .segment Data
    ...
    .byte 0
    message1: .text "finished probing for devices"
    .byte 0
}
.segment Code
...
// memset(void* zeropage($e) str, byte register(X) c, word zeropage(7) num)
memset: {
    .label end = 7
    .label dst = $e
    .label num = 7
